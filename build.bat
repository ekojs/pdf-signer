...
echo Class-Path: lib/gson-2.8.6.jar lib/commons-codec-1.11.jar lib/commons-logging-1.2.jar lib/pdfbox-2.0.21.jar lib/bcprov-jdk15on-165.jar lib/bcpkix-jdk15on-165.jar lib/fontbox-2.0.21.jar >> MANIFEST
