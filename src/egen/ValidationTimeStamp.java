...
public class ValidationTimeStamp
{
     ...
     */
    public ValidationTimeStamp(String tsaUrl, String username, String password) throws NoSuchAlgorithmException, MalformedURLException
    {
        if (tsaUrl != null)
        {
            MessageDigest digest = MessageDigest.getInstance("SHA-256");
            this.tsaClient = new TSAClient(new URL(tsaUrl), username, password, digest);
        }
    }
